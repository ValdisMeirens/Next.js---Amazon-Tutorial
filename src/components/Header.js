  ...
  return (
    <header>
      ...
      <div className="flex items-center space-x-3 p-2 pl-6 bg-amazon_blue-light text-white text-s">
        ...
        <p className="hidden lg:inline-flex ">Food & Glocery</p>
        <p className="hidden lg:inline-flex ">Prime</p>
        <p className="hidden lg:inline-flex ">Buy Again</p>
        <p className="hidden lg:inline-flex ">Shopper Tolkit</p>
        <p className="hidden lg:inline-flex ">Helth & Personal Care</p>
      </div>
    </header>
  );
}
